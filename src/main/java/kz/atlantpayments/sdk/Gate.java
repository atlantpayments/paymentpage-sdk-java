...
{
    /**
     * kz.atlantpayments.sdk.SignatureHandler instance for check signature
     */
    private SignatureHandler signatureHandler;

    /**
     * kz.atlantpayments.sdk.PaymentPage instance for build payment URL
     */
    private PaymentPage paymentPageUrlBuilder;

    /**
     * kz.atlantpayments.sdk.Gate constructor
     ...
     * @param payment kz.atlantpayments.sdk.Payment instance with payment params
     ...
     * @return kz.atlantpayments.sdk.Callback instance
